        ...
        namespace maintenance {
            ...
            void aux_cancel_sell_order(name owner, uint64_t id, uint64_t market) {
                ...
                action(
                    ...
                    get_self(),
                    name("swapdeposit"),
                    std::make_tuple(get_self(), owner, return_amount, string(TEXT_ACSO_2))
                ).send();
                asset _asset;
            ...
            string aux_maintenance_from_history(asset& pts, asset& exp) {
                ...
                int kprune_days = eosio::dex::global::get().kprune;
                ...
                historyblock blocks_table(get_self(), get_self().value);
            ...
            string aux_maintenance_from_points(asset& pts, asset& exp) {
                PRINT("eosio::dex::maintenance::aux_maintenance_from_points()\n");
                PRINT(" pts: ", pts.to_string(), "\n");
                PRINT(" exp: ", exp.to_string(), "\n");

                string report;
                int pprune_weeks = eosio::dex::global::get().pprune;
                uint32_t current_week = eosio::dex::global::get_current_week_number();
                ...
                points ptable(get_self(), get_self().value);
                int max = 3;
                int count = 0;
            ...
            void action_do_maintenance(name credits_to) {
                ...
                string report;
                asset points = asset(0, eosio::dex::experience::POINTS_SYMBOL);
                asset exp = asset(0, eosio::dex::experience::EXP_SYMBOL);
                PRINT("       --------------------------------\n");
