...
echo "-------- telosmaindex ---------"
cd $DEX_CONTRACT_DIR
if [[ $DEX_CONTRACT_DIR/../../include/dex/modules/client.hpp -nt telosmaindex.wasm      ||
      $DEX_CONTRACT_DIR/../../include/dex/modules/dao.hpp -nt telosmaindex.wasm         ||
      $DEX_CONTRACT_DIR/../../include/dex/modules/deposit.hpp -nt telosmaindex.wasm     ||
      $DEX_CONTRACT_DIR/../../include/dex/modules/error.hpp -nt telosmaindex.wasm       ||
      $DEX_CONTRACT_DIR/../../include/dex/modules/exchange.hpp -nt telosmaindex.wasm    ||
      $DEX_CONTRACT_DIR/../../include/dex/modules/experience.hpp -nt telosmaindex.wasm  ||
