    ...
    namespace dex {
        ...
        namespace experience {
            ...
            void aux_make_user_rampayer(name owner) {
                PRINT("eosio::dex::experience::aux_make_user_rampayer()\n");
                PRINT(" owner: ",owner.to_string()," \n");
                exp exptable(get_self(), get_self().value);
            ...
            void action_reward_user(name user, const asset& points_reward, const asset& exp_reward) {
                ...
                if (ptr != exptable.end()) {
                    ...
                    exptable.emplace(get_self(), [&](auto &a){
                        a.owner = user;
                        a.exp = exp_reward;
                    });
                }
                ...
                points pointstable(get_self(), get_self().value);
                ...
                if (itr != index.end()) {
                    ...
                    pointstable.emplace(get_self(), [&](auto &a){
                ...
                PRINT("eosio::dex::experience::action_reward_user() ------------------------------ (end)\n");
            }
        };     
    };
};
