...
cleos push action telosmaindex balloton '["hblockprune", ["1"], "hblockprune - sets days of expiration", "alice"]' -p alice
...
cleos push action telosmaindex balloton '["pointsprune", ["1"], "pointsprune - sets weeks of expiration for points", "alice"]' -p alice
...
cleos push action telosmaindex maintenance '["kate"]' -p kate && sleep 0.5
cleos push action telosmaindex maintenance '["kate"]' -p kate && sleep 0.5
cleos push action telosmaindex maintenance '["kate"]' -p kate && sleep 0.5
cleos push action telosmaindex maintenance '["kate"]' -p kate && sleep 0.5
cleos push action telosmaindex maintenance '["kate"]' -p kate && sleep 0.5
...
cleos push action telosmaindex order '["tom", "sell", "5.00000000 EDNA", "0.40000000 TLOS",0]' -p tom
cleos push action telosmaindex order '["tom", "sell", "5.00000000 EDNA", "0.41000000 TLOS",0]' -p tom
cleos push action telosmaindex order '["tom", "sell", "5.00000000 EDNA", "0.42000000 TLOS",0]' -p tom
cleos push action telosmaindex order '["tom", "sell", "5.00000000 EDNA", "0.43000000 TLOS",0]' -p tom
cleos push action telosmaindex order '["tom", "sell", "5.00000000 EDNA", "0.44000000 TLOS",0]' -p tom
...
cleos push action telosmaindex order '["kate", "buy", "5.00000000 EDNA", "0.10000000 TLOS",0]' -p kate
cleos push action telosmaindex order '["kate", "buy", "5.00000000 EDNA", "0.11000000 TLOS",0]' -p kate
cleos push action telosmaindex order '["kate", "buy", "5.00000000 EDNA", "0.12000000 TLOS",0]' -p kate
cleos push action telosmaindex order '["kate", "buy", "5.00000000 EDNA", "0.13000000 TLOS",0]' -p kate
cleos push action telosmaindex order '["kate", "buy", "5.00000000 EDNA", "0.14000000 TLOS",0]' -p kate
cleos push action telosmaindex order '["kate", "buy", "5.00000000 EDNA", "0.15000000 TLOS",0]' -p kate
cleos push action telosmaindex order '["kate", "buy", "5.00000000 EDNA", "0.16000000 TLOS",0]' -p kate
...
cleos push action telosmaindex order '["bob", "buy", "5.00000000 EDNA", "0.40000000 TLOS",0]' -p bob
cleos push action telosmaindex order '["bob", "buy", "5.00000000 EDNA", "0.41000000 TLOS",0]' -p bob
cleos push action telosmaindex order '["bob", "buy", "5.00000000 EDNA", "0.42000000 TLOS",0]' -p bob
cleos push action telosmaindex order '["bob", "buy", "5.00000000 EDNA", "0.43000000 TLOS",0]' -p bob
cleos push action telosmaindex order '["bob", "buy", "5.00000000 EDNA", "0.44000000 TLOS",0]' -p bob

# cleos get table telosmaindex telosmaindex historyall
# sleep 1
# cleos push action telosmaindex maintenance '["alice"]' -p alice
# cleos get table telosmaindex telosmaindex historyall
# sleep 1
# cleos push action telosmaindex maintenance '["alice"]' -p alice
# cleos get table telosmaindex telosmaindex historyall
...
# 
# 
# cleos push action telosmaindex maintenance '["alice"]' -p alice && sleep 0.5
# cleos push action telosmaindex maintenance '["alice"]' -p alice && sleep 0.5
# cleos push action telosmaindex maintenance '["alice"]' -p alice && sleep 0.5
# cleos push action telosmaindex maintenance '["alice"]' -p alice && sleep 0.5
# cleos push action telosmaindex maintenance '["alice"]' -p alice && sleep 0.5
